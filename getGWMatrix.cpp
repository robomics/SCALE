...
unsigned int getMatrix(string fname, int binsize, string norm, string ob, bool interOnly, unsigned int **i0, unsigned int **j0, double **x0, long *m, vector<std::string> &CH,vector<int> &CHL) {
	string unit("BP");
	ifstream fin;
