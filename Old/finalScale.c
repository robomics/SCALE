...
int scale(long m,int *i,int *j,float *x, float *z,float *b, float *report,int *allIters, float tol,float *pppp,float *pppp1, int maxiter, int zerodiag, float del, float dp, float dp1,int *totIter)
{  
	long p;
	int k,n0;
