...
int scale(long m,int *i,int *j,real *x, real *z,real *b, real *report,int *allIters, int verb, double tol,double *pppp,double *pppp1, int maxiter, int zerodiag, double del, double dp, double dp1,int *totIter)
{  
	long p;
	int k,n0;
	real low, zhigh, zlow;
